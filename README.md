...
Set `MCP_SERVER_URL` to the deployed API MCP endpoint before starting the bot. The bot uses Groq as its primary chat provider and Gemini as its fallback. Telegram updates use long polling.
